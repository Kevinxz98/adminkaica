...
export class NavService implements OnDestroy {
  ...
  setMenuByRole(role: string) {
    const filteredItems = this.filterByRole(this.MENUITEMS, role);
    this.items.next(filteredItems);
  }

  private filterByRole(menuItems: Menu[], role: string): Menu[] {
    return menuItems
      .map((item) => {
